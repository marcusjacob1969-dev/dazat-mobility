...
export interface RecoverFatigueHandoverOwnershipRequest {
  readonly recoveryEvidenceReference: string;
}

export interface RecoverFatigueHandoverOwnershipProjection {
  readonly controlledHandoverId: string;
