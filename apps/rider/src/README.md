...
Phase 0.51 adds one Rider-facing progress surface across the persisted core journey. It reads the Phase 0.50 server projection, highlights the first incomplete or blocked milestone and never infers completion or payment from local UI state.
