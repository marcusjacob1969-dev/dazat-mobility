...
for (const truth of ["checkpoint: 'engineering-phase-0.31'", 'trustProxy: false', 'connectionTimeout: 10_000', 'requestTimeout: 30_000', 'keepAliveTimeout: 5_000', 'maxRequestsPerSocket: 100']) {
