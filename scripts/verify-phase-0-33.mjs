...
if (authRoutes.length < 20) errors.push(`Expected at least 20 authenticated route modules, found ${authRoutes.length}`);
...
console.log(`Checked one shared bounded bearer parser across all ${authRoutes.length} authenticated route modules.`);
