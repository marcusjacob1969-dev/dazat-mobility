...
const errors = [];
for (const truth of ['projectCoreJourneyProgress', "booking_status: 'ACTIVE_INCIDENT'", "disposition, 'SUPPORT_REQUIRED'", "checkpoint: 'engineering-phase-0.62'"]) if (!demo.includes(truth)) errors.push(`Vertical-slice demo truth missing: ${truth}`);
