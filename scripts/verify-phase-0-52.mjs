...
const errors = [];
for (const truth of ['getDriverCoreJourneyProgress', '/v1/driver/bookings/:bookingId/core-journey-progress', 'permitted_assignment.driver_profile_id = $2', 'readDriverCoreJourneyProgress', 'coreJourneyProgress.milestones']) if (!source.includes(truth)) errors.push(`Driver progress missing: ${truth}`);
