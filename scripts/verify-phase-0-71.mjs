...
const errors = [];
for (const truth of [
  "post('/v1/bookings'", '/quote`, tokens.actor', '/confirm`, tokens.actor', 'phase-071-create-booking',
...
if (!app.includes("checkpoint: 'engineering-phase-0.71'")) errors.push('Build metadata is not at Phase 0.71');
if (errors.length) {
