...
Turn the provider-disabled core-journey demonstration into an explicit executable safety catalogue for the demonstrable Rider → Driver → Journey → completion path.
